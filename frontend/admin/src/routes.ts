...
export const purchaseExportAll = (startDate: Date, endDate: Date) => `/api/v1/admin/purchases/exports/${startDate.toISOString().substring(0, 10)}/${endDate.toISOString().substring(0, 10)}`;
